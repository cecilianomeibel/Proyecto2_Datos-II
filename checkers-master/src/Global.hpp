...
const int XOFFSET = (WINDOW_WIDTH /
                     SQUARES_VERTICAL); // the horizontal offset, this is used to measure square and checker width
const int YOFFSET = (WINDOW_HEIGHT /
                     SQUARES_HORIZONTAL); // the vertical offset, this is used to measure square and checker width
...
const std::string WINDOW_TITLE = "Damas";
