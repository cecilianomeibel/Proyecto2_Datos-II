/*
* Este es el archivo de programa principal de Damas. La clase principal maneja selecciones de menú,
...
void Damas::start() {
    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            if ((event.type == sf::Event::Closed)
                || ((event.type == sf::Event::KeyPressed) &&
                    (event.key.code == sf::Keyboard::Escape))) // cerrar la ventana cuando esta en el menú
            {
                window.close();
            } else if ((event.type == sf::Event::KeyPressed) &&
                       (event.key.code == sf::Keyboard::C)) // jugador versus computadora
            {
                Game checkerGame(window, true, false);
        ...
        textA.setPosition(sf::Vector2f(30, 480));
        textB.setPosition(sf::Vector2f(105, 480));
        textC.setPosition(sf::Vector2f(180, 480));
        textD.setPosition(sf::Vector2f(255, 480));
        textE.setPosition(sf::Vector2f(330, 480));
        textF.setPosition(sf::Vector2f(410, 480));
        textG.setPosition(sf::Vector2f(480, 480));
        textH.setPosition(sf::Vector2f(550, 480));
        //Mostrar en pantalla
        window.draw(textA);
        window.draw(textB);
        window.draw(textC);
        ...
        //Seleccionar posicion del texto
        text1.setPosition(sf::Vector2f(620, 400));
        text2.setPosition(sf::Vector2f(620, 345));
        text3.setPosition(sf::Vector2f(620, 290));
        text4.setPosition(sf::Vector2f(620, 235));
        text5.setPosition(sf::Vector2f(620, 180));
        text6.setPosition(sf::Vector2f(620, 125));
        text7.setPosition(sf::Vector2f(620, 70));
        text8.setPosition(sf::Vector2f(620, 15));
        //Mostrar en pantalla
        window.draw(text1);
        window.draw(text2);
        window.draw(text3);
...
void Damas::loadTimes(sf::RenderWindow &window, sf::Event &event) {
...
void Damas::animation(sf::RenderWindow &window, const int &mouseOverX, const int &mouseOverY) {
